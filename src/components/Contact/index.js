...
function ContactForm() {
    ...
    return (
        <CForm id="contact-form" onSubmit={ handleSubmit }>
            ...
            <div className="mb-3">
                <CFormLabel className="text-white" htmlFor="name">Name: </CFormLabel>
                <CFormInput type="text" name="name" defaultValue={ name } onBlur={ handleChange } />
            </div>
            <div className="mb-3">
                <CFormLabel className="text-white" htmlFor="email">Email Address: </CFormLabel>
                <CFormInput type="email" name="email" defaultValue={ email } onBlur={ handleChange } />
            </div>
            <div className="mb-3">
                <CFormLabel className="text-white" htmlFor="message">Message: </CFormLabel>
